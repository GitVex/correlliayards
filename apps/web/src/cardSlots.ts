...
// getSlotBox) to render the real, data-driven icons/text, and the guide
// overlay in components/CardSlots.tsx draws them as labelled dashed outlines
// so you can keep tuning placement without hunting through CardFace's
// rendering logic. Turn SHOW_GUIDES off once you're happy — that only hides
// the guide, it doesn't touch position or the live render.
//
// Data and no JSX, deliberately: a module that exports both a component and
// the constants around it cannot be hot-replaced, and this is the one file
// where you want the numbers to reload as you type them.
// ---------------------------------------------------------------------------
